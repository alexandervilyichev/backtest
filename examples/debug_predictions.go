...
func main() {
	...
	// Тест 1: Predictive Linear Spline
	fmt.Println("═══════════════════════════════════════════════════════════")
	fmt.Println("Тест 1: Predictive Linear Spline Strategy")
	fmt.Println("═══════════════════════════════════════════════════════════")
	...
	// Тест 2: Elliott Wave
	fmt.Println("═══════════════════════════════════════════════════════════")
	fmt.Println("Тест 2: Elliott Wave Strategy")
	fmt.Println("═══════════════════════════════════════════════════════════")
	...
	if plsSignal != nil && ewSignal != nil {
		...
		fmt.Println("═══════════════════════════════════════════════════════════")
		fmt.Printf("Разница во времени: %d секунд\n", ewSignal.Date-plsSignal.Date)
		fmt.Printf("Разница в цене: %.4f\n", ewSignal.Price-plsSignal.Price)
